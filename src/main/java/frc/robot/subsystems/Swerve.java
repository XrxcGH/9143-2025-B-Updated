...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
    ...
    /**
     * Sets the currently active SysId routine.
     *
     * Intentionally not called anywhere by default. This is a
    ...
    /**
     * Returns whether vision tracking is currently enabled.
     *
    ...
    public Command createAprilTagTrackingCommand() {
        return startRun(() -> {
            ...
            // direction is along it, so the direction of travel turns
     ...
     *                         (for example, from LimelightHelpers); it is converted to
